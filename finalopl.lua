...
local easyMobs = {
    ...
    ["Lv34 Freddi"] = true, ["Lv4 Angry Freddy"] = true, ["Lv4 Boar"] = true, ["Lv4 Crab"] = true, ["Lv40 Thug"] = true,
    ["Lv5 Crab"] = true, ["Lv9 Bandit Traitor"] = true, ["Lv219 Cave Demon"] = true,
}
...
local function toggleFly()
    ...
    if FlyEnabled then
        ...
        FlyBodyGyro.CFrame = CFrame.new(root.Position, root.Position + workspace.CurrentCamera.CFrame.LookVector)
        ...
        FlyConnection = RunService.Heartbeat:Connect(function()
            ...
            FlyBodyGyro.CFrame = CFrame.new(currentRoot.Position, currentRoot.Position + cam.CFrame.LookVector)
        end)
    else
